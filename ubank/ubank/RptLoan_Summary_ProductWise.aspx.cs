...
namespace ubank
{
    public partial class RptLoan_Summary_ProductWise : System.Web.UI.Page
    {
        RptLoan_Summary_ProductWiseRPT rd = new RptLoan_Summary_ProductWiseRPT();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String Query1 = @"Select PROD_TYPE, DAT_START, DAT_END, AType_DESC Loan_Product, Sum(STARTBAL) STARTBAL, Sum(CLOSEBAL) CLOSEBAL, " +
...
"Inner Join System.t_AccType A on A.ATYPE_GL = SUBSTR (S.ACCOUNTNUMBER, 5, 7) and A.AT_CAT_CODE in (6,7,8) " +
