<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RptLoan_Summary_ProductWise.aspx.cs" Inherits="ubank.RptLoan_Summary_ProductWise" %>
    ...
    <tr>
        <td colspan="3">
            ...
            <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                <Report FileName="RptLoan_Summary_ProductWiseRPT.rpt">
                </Report>
