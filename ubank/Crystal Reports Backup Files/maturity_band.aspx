<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="maturity_band.aspx.cs" Inherits="ubank.maturity_band" %>
     ...
     <table style="width:100%; font-size: small;">
        <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="ConnDesc" DataValueField="ConnCode" Height="16px" Width="232px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" >
                </asp:DropDownList>
